    ...
    <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div class="panel">
            ...
            <div class="quick-list">
                <button class="quick-item" data-report-range="today">
                ...
                <button class="quick-item" data-report-range="week">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <rect x="3" y="4" width="18" height="17" rx="1.5"/>
                    </svg>
                    7 Hari Terakhir
                ...
                <button class="quick-item" data-report-range="month">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <rect x="3" y="4" width="18" height="17" rx="1.5"/>
                    </svg>
                    30 Hari Terakhir
                ...
                <button class="quick-item" data-report-range="year">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <rect x="3" y="4" width="18" height="17" rx="1.5"/>
                    </svg>
                    Tahun Ini
